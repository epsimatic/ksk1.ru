    ...
    <aside id="sidenav" class="snap-drawer snap-drawer-left visible-xs visible-sm" role="navigation">
        <ul class="menu-sidenav menu-sidenav-main">
            <li class="menu-item menu-item-has-children menu-main-news">
                <a href="//ksk66.ru/"><span class="triangle"></span>Новости</a>
                <ul class="sub-menu">
            ...
            <li class="menu-item menu-item-has-children menu-main-shop">
                <a href="//krasnoufimsk.e96.ru/"><span class="triangle"></span>Магазины</a>
                <ul class="sub-menu">
                    <li class="menu-item sub-menu-e96_shop"><a href="//krasnoufimsk.e96.ru/">E96</a></li>
                    ...
                    <!--<li class="menu-item sub-menu-sale_shop"><a href="//e96.ru/actions">Акции E96</a></li>-->
                </ul>
            </li>
            ...
            <li class="menu-item menu-item-has-children menu-main-more">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="menu-item sub-menu-krsk"><a target="_blank" href="//xn--80aqecjehnketm.xn--p1ai"><img src="https://ksk1.ru/favicon_kr.png" alt="Фавикон"> Красноуфимск.рф</a></li>   <!--<i class="fa fa-fw fa-vk"></i> Кск-Екб транзит-->
        ...
        <ul class="menu-sidenav menu-sidenav-aux">
            <li class="menu-item weather-container row">
                <!--# include virtual="/weather/conditions.html" -->
            </li>
...
<li class="menu-item-dropdown menu-item menu-main-news">
    <a  class="news-link" role="button" aria-haspopup="true" aria-expanded="false" href="//ksk66.ru/">КСК<span class="lightweight">66</span></a>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div role="group" class="btn-group-vertical btn-block">
                        <a href="//ksk66.ru/" class="btn btn-link hidden">
                            <i class="fa fa-fw fa-newspaper-o"></i> Все новости
                        </a>
                        <a href="//ksk66.ru/category/main_news/" class="btn btn-link">
                            <i class="fa fa-fw fa-bullhorn"></i> Главные новости
                        </a>
                        <a href="//ksk66.ru/category/mail/" class="btn btn-link">
                            <i class="fa fa-fw fa-envelope"></i> Письма читателей
                        </a>
                        <a href="//ksk66.ru/r-site/" class="btn btn-link">
                            <i class="fa fa-fw fa-money"></i> Реклама у нас
                        </a>
                        <a href="//ksk66.ru/mail/" class="btn btn-action">
                ...
                <!--<div class="col-md-3">
                    <a href="//ksk66.ru/posrednik-list" class="clearfix">
            ...
            <div class="row">
                ...
                <div class="col-md-9 ob-promo">
                    ...
                    <div class="ob-promo-body">
                        ...
                        <!--<a href="//ksk66.ru/company/%D0%BA%D1%83%D1%85%D0%BE%D0%BD%D1%8C%D0%BA%D0%B0/"><img src="https://ksk1.ru/img/kuhonka-20161226.jpg" alt="Кухонька"></a>-->
                        <a href="//ksk66.ru/company/lombard/"><img src="https://ksk1.ru//img/lombard-klassika-20170214.jpg" alt="Ломбард"></a>
                    </div>
                </div>
            </div>
        </div>
...
<li class="menu-item-dropdown menu-item menu-main-agenda">
    <a class="featured" href="//ksk66.ru/agenda/" aria-haspopup="true" aria-expanded="false" >Афиша</a>
    <div class="dropdown-panel">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-3 submenu submenu-catalog ">
                    <a href="//ksk66.ru/cat/" class="clearfix">
                ...
                <!--<div class="col-sm-3 submenu submenu-agenda hidden">
                    <a href="//ksk66.ru/agenda/" class="clearfix">
                ...
                <div class="col-sm-3 submenu submenu-timetable">
                    <a href="//ksk66.ru/city-transport/" class="clearfix">
                ...
                <div class="col-sm-3 submenu submenu-map">
                    <a href="//ksk66.ru/map/" class="clearfix">
                ...
                <div class="col-sm-3 submenu submenu-emergency">
                    <a href="//ksk66.ru/emergency/" class="clearfix">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-4 col-lg-3 submenu-group">
                    <a class="btn btn-link tv_radio-radio" href="//ksk66.ru/radio/">
                        <i class="fa fa-fw fa-volume-up"></i> Радио «Красноуфимск»
                    </a>
                    <a href="//ksk66.ru/videos/" class="btn btn-link">
                        <i class="fa fa-fw fa-film"></i> Видео дня
                    </a>
                    <a  href="//ksk66.ru/photos/" class="btn btn-link">
                        <i class="fa fa-fw fa-photo"></i> Фото дня
                    </a>
                ...
                <div class="col-sm-4 col-lg-3 submenu-group">
                    <div class="player-header">
                        <a class="player-logo" href="//ksk66.ru/radio/">
...
<li class="menu-item-dropdown menu-item menu-main-shop">
    <span aria-haspopup="true" aria-expanded="false">Магазины</span>
    <div class="dropdown-panel">
        <div class="container">
            <div class="row">
                <div class="col-md-9 col-lg-8 shop-list">
                    <a href="//ozon.ru/" target="_blank">
                    ...
                    <a target="_blank" href="//krasnoufimsk.e96.ru/">
...
<li class="menu-item-dropdown menu-item menu-main-taxi">
    <a class="featured" role="button" aria-haspopup="true" aria-expanded="false" href="//ksk66.ru/taxi">
    ...
    <div class="dropdown-panel">
        <div class="container">
            ...
            <a href="//ksk66.ru/taxi" class="btn btn-taxi-order">
            ...
            <div class="btn-group-featured">
                <a class="btn-featured btn-featured-apps" target="_blank" href="https://play.google.com/store/apps/details?id=ru.taximaster.tmtaxicaller.id2187">
                    <img alt="Google Play Badge" src="//ksk66.ru/wp-content/themes/rootstrap-ksk66/images/Google_Play_Badge_RU_135x40.svg">
                </a>
                <a class="btn-featured btn-featured-apps" target="_blank" href="https://itunes.apple.com/ru/app/taksi-online-7-99-99/id1116935376?ls=1&amp;mt=8">
                    <img alt="App Store Bage" src="//ksk66.ru/wp-content/themes/rootstrap-ksk66/images/App_Store_Badge_RU_135x40.svg">
                </a>
        ...
        <div class="container">
            <div class="row services-info-containter">
                <div class="col-sm-6 service-info service-info-cargo">
                    <a href="//ksk66.ru/cargo-delivery" class="service-info-inner">
                ...
                <div class="col-sm-6 service-info service-info-workers">
                    <a href="//ksk66.ru/workers" class="service-info-inner">
...
<li class="menu-item-dropdown menu-item menu-main-more">
    ...
    <ul class="dropdown-panel">
        ...
        <li class="menu-item sub-menu-copy"><a href="//ksk66.ru/copy">Копицентр</a></li>
        <li class="menu-item sub-menu-transit"><a target="_blank" href="//vk.com/kskekb"><i class="fa fa-fw fa-vk"></i> Кск-Екб транзит</a></li>
        <li class="menu-item sub-menu-krsk"><a target="_blank" href="//xn--80aqecjehnketm.xn--p1ai"><img src="https://ksk1.ru/favicon_kr.png" alt="Фавикон"> Красноуфимск.рф</a></li>
        <!--<li class="menu-item sub-menu-webdev"><a href="//ksk66.ru/r-webdev">Разработка сайтов</a></li>-->
    </ul>
</li>
</ul>
<ul class="nav navbar-nav navbar-right">
    <li class="dropdown menu-item dropdown-weather"><!--# include virtual="/weather/conditions.html" -->
...
<div id="content" class="snap-content">
    <header class="mobile-header visible-xs visible-sm noprint">
        ...
        <div class="logo-placeholder text-center noprint">
            <a href="//ksk66.ru/" class="logo-ksk">КСК<span class="lightweight">66</span><span class="sr-only">Красноуфимск онлайн</span></a>
        </div>
    </header>
